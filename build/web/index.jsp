<%-- 
    Document   : index
    Created on : 3/10/2023, 10:53:39 p. m.
    Author     : Bartsam
--%>
...
<html>
    <head>
        ...
        <title>Bartsam Store</title>
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="#">Bartsam Store</a>
                    ...
                    <div class="col-sm-4">
                        <div class="card" align="center">
                            ...
                            <div class="card-body" align="center">
                                ...
                                <br>
                                <i>$ ${p.getPrecioProducto()}</i>                           
                            </div>
                            <div class="card-footer" text="center">
                                <label>Descripción: ${p.getDescProducto()}</label>
                                <div>
